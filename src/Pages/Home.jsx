...
const Home = () => {
  ...
  return (
    <Box>
      ...
      <Box border={"4px solid red"} w={["100%", "100%", "100%", "78%"]} m="auto">
        <Box
        ...
        {/* industry vetran */}
        <hr className="line" />
        <Box className="trustee" mt={[4,4,4,4]} mb={[4,4,4,4]} border={'3px solid teal'}>
          <Flex display={['block','block','block','flex']}>
            <Box mt={[2,2,3,4]} textAlign={["none","none","center","center"]} w={["90%","90%","100%","30%"]}>
        ...
        <Box mt={6} border='3px solid black'>
          <Flex justifyContent={['none','none',"space-between","space-between"]} display={['block','block','flex','flex']} gap={[4,4,'none','none']}>
        ...
        <Box mt="5">
          ...
          <Flex flexWrap="wrap" > 
            <Box 
            flexBasis={`${100 / numColumns}%`} h={['150px','150px','200px','220px']} className="four-box"></Box>
            <Box 
            flexBasis={`${100 / numColumns}%`} h={['150px','150px','200px','220px']} className="four-box"></Box>
            <Box 
            flexBasis={`${100 / numColumns}%`} h={['150px','150px','200px','220px']} className="four-box"></Box>
        ...
        <Box border={"3px solid red"} w="100%" mt={[4, 4, 4, 4]}>
          <Box border="3px solid green" w="100%" h="30%">
